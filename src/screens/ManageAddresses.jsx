...
const ManageAddresses = () => {
    ...
    // For new address form fields
    const [firstName, setFirstName] = useState('');
    const [lastName, setLastName] = useState('');
    const [address1, setAddress1] = useState('');
    const [address2, setAddress2] = useState('');
    const [city, setCity] = useState('');
    const [region, setRegion] = useState('');      // e.g. state/province
    ...
    // --------------------------
    // 2. Toggle the "Add Address" pop-up
    // --------------------------
    const togglePopUp = () => {
    ...
    // --------------------------
    // 4. Mutations: Add, Delete, Set default
    // --------------------------
    ...
    return (
      <Fade in={!addressesLoading}>
        <div>
          {/* BACKDROP for "Add Address" popup */}
          ...
          {/* SLIDE-UP for "Add Address" popup */}
